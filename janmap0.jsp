...
薬草<button  name ="jspMap" value="janmap0.jsp">使用</button>
</form>
...
if(ran1 != 1){	vi1 = "_1";	v1 = "<a href=\"/janjyon/MoveMap1?action=leftMov\">";	 v2 = "</a>";
			vision1 = "<a href=" + "\"/janjyon/MoveMap1?action=leftMov\"" + ">左へ進む　　</a>";}
if(ran2 != 1){	vi2 = "_2";	v3 = "<a href=\"/janjyon/MoveMap1?action=upMov\">";	 v4 = "</a>";
			vision2 = "<a href=" + "\"/janjyon/MoveMap1?action=upMov\"" + " >上へ進む　　</a>";}
if(ran3 != 1){	vi3 = "_1";	v5 = "<a href=\"/janjyon/MoveMap1?action=rightMov\">";	 v6 = "</a>";
			vision3 = "<a href=" + "\"/janjyon/MoveMap1?action=rightMov\"" + ">右へ進む　　</a>";}
%>
<p>進行方向を選択してください　
...
<div id="sc4" ><%= v1 %><img src="img/bac1<%= vi1 %>.jpg" width="320" height="180"><%= v2 %></div>
<div id="sc5" ><img src="img/bac1_10.jpg" width="320" height="180"></div>
<div id="sc6" ><%= v5 %><img src="img/bac1<%= vi3 %>.jpg" width="320" height="180"><%= v6 %></div>

<div id="sc7" ><img src="img/bac1.jpg" width="320" height="180"></div>
<div id="sc8" ><img src="img/bac1_2p.jpg" width="320" height="180"></div>
