...
<h1><%= msg %></h1>
<form action="/janjyon/MoveMap2" method="post">
薬草<button  name ="jspMap" value="tMap3.jsp">使用</button>
</form>
<%
String vision1 = "";
String vision2 = "";
...
if(ran2 != 1){	vi2 = "_1";	v3 = "<a href=\"/janjyon/MoveMap2?action=rightMov\">";	 v4 = "</a>";
			vision2 = "<a href=" + "\"/janjyon/MoveMap2?action=rightMov\"" + " >右へ進む　　</a>";}
if(ran3 != 1){	vi3 = "_2";	v5 = "<a href=\"/janjyon/MoveMap2?action=downMov\">";	 v6 = "</a>";
			vision3 = "<a href=" + "\"/janjyon/MoveMap2?action=downMov\"" + ">下へ進む　　</a>";}
%>
<p>　　　進行方向を選択してください　
...
<div id="sc2" ><img src="img/bac2_2p.png" width="320" height="180"></div>
...
<div id="sc5" ><img src="img/bac2_10.png" width="320" height="180"></div>
<div id="sc6" ><%= v3 %><img src="img/bac2<%= vi2 %>.png" width="320" height="180"><%= v4 %></div>

<div id="sc7" ><img src="img/bac2.png" width="320" height="180"></div>
<div id="sc8" ><%= v5 %><img src="img/bac2<%= vi3 %>.png" width="320" height="180"><%= v6 %></div>
