...
薬草<button  name ="jspMap" value="janmap3.jsp">使用</button>
</form>
...
if(ran2 != 1){	vi2 = "_1";	v3 = "<a href=\"/janjyon/MoveMap1?action=rightMov\">";	 v4 = "</a>";
			vision2 = "<a href=" + "\"/janjyon/MoveMap1?action=rightMov\"" + " >右へ進む　　</a>";}
...
<div id="sc2" ><img src="img/bac1_2p.jpg" width="320" height="180"></div>
...
<div id="sc6" ><%= v3 %><img src="img/bac1<%= vi2 %>.jpg" width="320" height="180"><%= v4 %></div>
