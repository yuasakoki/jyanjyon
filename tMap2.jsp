...
薬草<button  name ="jspMap" value="tMap2.jsp">使用</button>
</form>
<%
String vision1 = "";
String vision2 = "";
...
if(ran1 != 1){	vi1 = "_1";  v1 = "<a href=\"/janjyon/MoveMap2?action=rightMov\">";	 v2 = "</a>";
			vision1 = "<a href=" + "\"/janjyon/MoveMap2?action=rightMov\"" + ">右へ進む　　</a>";}
...
<div id="sc4" ><img src="img/bac2_1p.png" width="320" height="180"></div>
<div id="sc5" ><img src="img/bac2_10.png" width="320" height="180"></div>
<div id="sc6" ><%= v1 %><img src="img/bac2<%= vi1 %>.png" width="320" height="180"><%= v2%></div>
